...
This project is a [Max](https://cycling74.com/products/max/) patch for reading and processing CSV files dynamically at audio signal rate. A key feature is having multiple instances of the patch effect each other.
